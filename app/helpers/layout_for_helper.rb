...
module LayoutFor
  ...
  class UserMenuBuilder
    attr_accessor :context, :name, :title, :tagline, :avitar,
                  :links, :profile, :signout
  ...
  class LayoutBuilder
    ...
    def render
      self.context.render_page_for(partial: "layouts/application", locals: {layout_builder: self})
    end
